...
<form method="POST">
	<label for="name">Nome <small>(obrigatório)</small></label><br/>
	<input type="text" name="name" required /><br/><br/>

	<label for="email">E-mail <small>(obrigatório)</small></label><br/>
	<input type="email" name="email"  /><br/><br/>

	<label for="phone">Telefone <small>(obrigatório)</small></label><br/>
