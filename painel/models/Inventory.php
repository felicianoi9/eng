...
class Inventory extends Model{
	...
	public function getInfo($id_product, $id_company) {
		$array = array();

		$sql = $this->db->prepare("SELECT * FROM inventory WHERE id_company = :id_company AND id=:id");
		$sql->bindValue(":id_company", $id_company);
	...
	public function setLog($id_product, $id_company, $id_user, $action) {
		...
		$sql="INSERT INTO inventory_history SET id_product=:id_product, id_user=:id_user, id_company=:id_company, action=:action, date_action=NOW()";
	...
	public function enterProduct($id_company, $id_user, $name, $price, $quant  ){
		...
		$sql = $this->db->prepare("INSERT INTO inventory SET  id_company=:id_company, id_user=:id_user, name=:name, purchase_price=:purchase_price, quant=:quant , min_quant=1");
		$sql->bindValue(":id_company",$id_company);
		$sql->bindValue(":id_user",$id_user);
		$sql->bindValue(":name",$name);
		$sql->bindValue(":purchase_price",$price);
