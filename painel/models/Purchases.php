...
class Purchases extends Model{
	...
	public function addPurchases($id_company, $id_provider, $id_user, $name, $quant, $status, $price ){
		...
		$sqlp = $this->db->prepare("INSERT INTO purchases_products SET id_company=:id_company , id_purchase=:id_purchase, name=:name, quant=:quant, purchase_price=:purchase_price");
