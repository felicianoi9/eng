...
class Permissions extends Model{
	...
	//Obtem o grupo e permissões do usuário e armazena nas variáveis $group e $permmissions , acima.  
	...
	public function addGroup($name, $list, $id_company){
		...
		$sql = $this->db->prepare("INSERT INTO permission_groups SET group_name=:group_name , id_company = :id_company, params = :params ");
		$sql->bindValue(':group_name',$name);
		$sql->bindValue(':id_company',$id_company);
	...
	public function editGroup($name, $list, $id, $id_company){
		...
		$sql = $this->db->prepare("UPDATE permission_groups SET group_name=:group_name , id_company = :id_company, params = :params WHERE id =:id ");
		$sql->bindValue(':group_name',$name);
		$sql->bindValue(':id',$id);
		$sql->bindValue(':id_company',$id_company);
		$sql->bindValue(':params',$params);
